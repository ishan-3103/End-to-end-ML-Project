...
class ModelTrainer:
    ...
    try:
        ...
        def initiate_model_training(self,train_arr,test_arr):
            ...
            models_report: dict=evaluate_model(X_train,Y_train,X_test,Y_test,models,params=params) 
            ...
            if(best_model_score<0.6):
                raise CustomException("Did not find any suitable model")

            logging.info("Found best model for training and testing")
